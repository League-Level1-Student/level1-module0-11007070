...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "The correct person is Arnold.");
		}
		...
		if (guess2.equalsIgnoreCase("leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "Wrong!");
			JOptionPane.showMessageDialog(null, "The correct person is Leonardo.");
		}
		showNextImage();
		...
		if (guess3.equalsIgnoreCase("morgan")) {
			...
			JOptionPane.showMessageDialog(null, "Wrong!");
			JOptionPane.showMessageDialog(null, "The correct person is Morgan.");
		}
